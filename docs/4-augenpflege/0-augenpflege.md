...
## Digitale Augenbelastung bekämpfen

Weltweit leiden immer mehr Menschen unter Kurzsichtigkeit (Myopie), und Expertinnen und Experten sprechen bereits von einer „[Myopie-Pandemie](https://pubmed.ncbi.nlm.nih.gov/33489329/)". Besonders betroffen sind junge Erwachsene und Kinder, die täglich mehrere Stunden vor Bildschirmen verbringen. [Studien zeigen](https://pubmed.ncbi.nlm.nih.gov/32738229/), dass intensive Naharbeit am Computer, Smartphone oder Tablet nicht nur die Entwicklung von Kurzsichtigkeit begünstigt, sondern auch zu digitaler Augenbelastung (auch „[Computer Vision Syndrome](https://pubmed.ncbi.nlm.nih.gov/35809192/)" genannt) führt. Symptome sind trockene, brennende Augen, verschwommenes Sehen, Kopfschmerzen und Nackenverspannungen.

### Die 20-20-20-Regel

Eine einfache und effektive Methode, um deine Augen bei der Bildschirmarbeit zu entlasten, ist die **20-20-20-Regel**:

> Nach jeweils 20 Minuten Bildschirmarbeit machst du 20 Sekunden Pause und richtest deinen Blick auf einen Punkt, der mindestens 20 Fuß (etwa 6 Meter) entfernt liegt.

Diese Regel hilft dabei, die Augenmuskulatur zu entspannen, den Tränenfilm zu stabilisieren und die Ermüdung zu reduzieren. Viele Menschen vergessen jedoch im Arbeitsalltag, regelmäßig Pausen einzulegen. Hier können digitale Helfer unterstützen, die automatisch an Bildschirmpausen erinnern.

### LookAway

[LookAway](https://lookaway.com/) ist eine App für macOS, die dich daran erinnert, regelmäßig vom Bildschirm aufzublicken und deinen Augen eine Pause zu gönnen. Sie basiert auf der 20-20-20-Regel und lässt sich individuell an deine Bedürfnisse anpassen.

### Apple Screen Distance (Bildschirmabstand)

Apple bietet auf seinen Geräten eine [Bildschirmabstand-Funktion](https://support.apple.com/de-de/105007) an, die automatisch erkennt, wenn du dein iPhone oder iPad zu nah vor das Gesicht hältst. Die Funktion nutzt die TrueDepth-Kamera und warnt dich, wenn du länger als eine gewisse Zeit in einem zu geringen Abstand auf den Bildschirm schaust. Dies kann besonders bei Kindern und Jugendlichen dazu beitragen, das Risiko für die Entwicklung von Kurzsichtigkeit zu verringern.
